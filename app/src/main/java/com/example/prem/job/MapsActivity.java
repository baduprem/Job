...
import com.example.prem.job.DataManager.ApiClient;
import com.example.prem.job.DataManager.ApiInterface;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    //variable for google map auto created
    private GoogleMap mMap;
    //variable form validation of contact to receive id
    private Button submit;
    private EditText uname, email,contact_number, message;
    private TextView call, t_v_email;
    // to store validated valuse
